...
Insert into pessoa(nome,ativo,logradouro,numero,complemento,bairro,cep,cidade,estado) 
	values('Alessandra',false,'rua exemplo ','111','Março 2','Mutinga','06003-000','Osasco','São Paulo');
	
Insert into pessoa(nome,ativo,logradouro,numero,complemento,bairro,cep,cidade,estado) 
	values('Gabriel Max',true,'Rua exemplo','112','ao lado da praça','Exemplo 1','11233-000','Barueri','São Paulo');
	
Insert into pessoa(nome,ativo,logradouro,numero,complemento,bairro,cep,cidade,estado) 
	values('Miguel Castro',true,'Rua exemplo','113','','barueri','18233-000','Barueri','São Paulo');
	
Insert into pessoa(nome,ativo) 
	values('Pedro Arantes',false);
